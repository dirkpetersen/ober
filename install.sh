...
echo ""
echo "Next steps:"
echo "  1. Run 'sudo ober bootstrap' to set up HAProxy and ExaBGP"
echo "  2. Run 'sudo ober config' to configure your cluster"
echo "  3. Run 'sudo ober doctor' to verify prerequisites"
